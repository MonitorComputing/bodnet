...
TXUFLAG		EQU     3           ; Transmit byte buffer 'clear' status bit
...
SrvcRxD		ServiceRx serDTmr, RXDPORT, RXDBIT, serDBitCnt, INT2K5INI, serStatus, RXDERR, RXDBREAK, serDReg, serDByt, RXDFLAG, INT2K5BIT
...
SrvcTxD		ServiceTx serDTmr, serStatus, serDByt, serDReg, TXDFLAG, serDBitCnt, INT2K5BIT, TXDPORT, TXDBIT, 0, 0
